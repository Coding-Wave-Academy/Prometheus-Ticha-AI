...
const sampleWatchedVideos: WatchedVideoItem[] = [
  {
    ...
    duration: "4:15",
    bgColor: "bg-[#FFB040]",
    summary: "Visual explanation of magnetic flux, EMF, and Lenz's law.",
  },
  {
    id: "sample-2",
    subject: "Pure Mathematics",
    topic: "The Binomial Theorem & Pascal's Triangle",
    youtubeId: "nSb_V_8Y5h0",
    channelTitle: "The Organic Chemistry Tutor",
    duration: "5:30",
    bgColor: "bg-[#B6FF00]",
    summary: "Learn binomial expansions, combinations formula, and exam patterns.",
  },
  {
    id: "sample-3",
  ...
  },
  {
    ...
    youtubeId: "xuPl_8wv9xo",
    channelTitle: "Professor Dave Explains",
    duration: "5:00",
    bgColor: "bg-[#FFD9E0]",
    summary: "Orbitals, electron filling principles, and energy levels for GCE exam success.",
  },
];
