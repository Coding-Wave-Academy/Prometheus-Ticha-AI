...
export default function Home() {
  ...
  useEffect(() => {
    setIsMounted(true);
    // Determine if the user has completed onboarding or logged in previously
      ...
      <section className="bg-white border-t-[4px] border-b-[4px] border-black py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-[#FAF7EC] border-[3.5px] border-black rounded-2xl p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] space-y-4">
            ...
            {/* Feature 2 */}
            <div className="bg-[#D3E2FF] border-[3.5px] border-black rounded-2xl p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] space-y-4">
            ...
            {/* Feature 3 */}
            <div className="bg-[#FFD9E0] border-[3.5px] border-black rounded-2xl p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] space-y-4">
              <div className="w-12 h-12 bg-white border-[2.5px] border-black rounded-xl flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                <span className="text-xl select-none">📁</span>
              </div>
              <h3 className="text-xl font-black uppercase tracking-tight text-black">
